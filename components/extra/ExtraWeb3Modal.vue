<template>
  <div class="fixed top-0  bottom-0 left-0 right-0 grid justify-center bg-black bg-opacity-60" @click="hideWeb3Modal()">
    <div class="mt-8 max-h-[32rem] overflow-scroll bg-bgSecondary-light dark:bg-bgSecondary-dark block w-80 text-center relative" @click.stop="">
      <span class="pr-3 pt-2 pl-1 pb-1 absolute right-0 top-0 cursor-pointer" @click="hideWeb3Modal()">X</span>
      <div class="mt-8 mb-4">
        Choose your web3 authenticator <br>to sign messages
      </div>
